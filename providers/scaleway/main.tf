...
resource "kubernetes_service_account" "provider_scaleway" {
  metadata {
    name      = "external-dns"
    namespace = "default"
  }
...
resource "kubernetes_cluster_role" "provider_scaleway" {
  metadata {
    name = "external-dns"
  }
...
resource "kubernetes_cluster_role_binding" "provider_scaleway" {
  metadata {
    name = "external-dns"
  }
  role_ref {
